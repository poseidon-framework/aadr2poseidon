### ISSUE_MM: I'm not sure how the publication validation is supposed to work so not sure how to check whether it all is fine
...
# file.remove(
#   "AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/DOIs.txt",
#   "AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/citation_keys.txt",
#   "AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/aadr2doi_result.txt",
...
writeLines(keys, "AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/citation_keys.txt")
...
system(paste(
  "aadr2doi",
  "--inFile AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/citation_keys.txt",
  "--aadrVersion 54.1.p1",
  "--doiShape Short",
  "--printKey",
  "-o AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/aadr2doi_result.txt"
  ))
...
# write dois to file
writeLines(final_doi_table$doi, "AADR54.1.p1_to_Poseidon2.7.0_1240K/tmp/DOIs.txt")
