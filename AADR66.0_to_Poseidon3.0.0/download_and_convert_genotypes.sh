...
trident genoconvert -p tmp/AADR_v66_1240K.geno --outFormat PLINK --zip -o tmp/AADR_v66_1240K
...
# convert to EIGENSTRAT
cat > tmp/convertf_parfile_AADR_v66_2M <<EOF
genotypename: tmp/v66.2M.aadr.PUB.geno
snpname: tmp/v66.2M.aadr.PUB.snp
indivname: tmp/v66.2M.aadr.PUB.ind
outputformat: EIGENSTRAT
genotypeoutname: tmp/AADR_v66_2M.geno
snpoutname: tmp/AADR_v66_2M.snp
indivoutname: tmp/AADR_v66_2M.ind
EOF
convertf -p tmp/convertf_parfile_AADR_v66_2M
# convert to binary PLINK
trident genoconvert -p tmp/AADR_v66_2M.geno --outFormat PLINK --zip -o tmp/AADR_v66_2M
...
# convert to EIGENSTRAT
cat > tmp/convertf_parfile_AADR_v66_2M_compatibility <<EOF
genotypename: tmp/v66.2M_compatibility.aadr.PUB.geno
snpname: tmp/v66.2M_compatibility.aadr.PUB.snp
indivname: tmp/v66.2M_compatibility.aadr.PUB.ind
outputformat: EIGENSTRAT
genotypeoutname: tmp/AADR_v66_2M_compatibility.geno
snpoutname: tmp/AADR_v66_2M_compatibility.snp
indivoutname: tmp/AADR_v66_2M_compatibility.ind
EOF
convertf -p tmp/convertf_parfile_AADR_v66_2M_compatibility
# convert to binary PLINK
trident genoconvert -p tmp/AADR_v66_2M_compatibility.geno --outFormat PLINK --zip -o tmp/AADR_v66_2M_compatibility
...
# convert to EIGENSTRAT
cat > tmp/convertf_parfile_AADR_v66_HO <<EOF
genotypename: tmp/v66.HO.aadr.PUB.geno
snpname: tmp/v66.HO.aadr.PUB.snp
indivname: tmp/v66.HO.aadr.PUB.ind
outputformat: EIGENSTRAT
genotypeoutname: tmp/AADR_v66_HO.geno
snpoutname: tmp/AADR_v66_HO.snp
indivoutname: tmp/AADR_v66_HO.ind
EOF
convertf -p tmp/convertf_parfile_AADR_v66_HO
# convert to binary PLINK
trident genoconvert -p tmp/AADR_v66_HO.geno --outFormat PLINK --zip -o tmp/AADR_v66_HO
...
# convert to EIGENSTRAT
cat > tmp/convertf_parfile_AADR_v66_HO_compatibility <<EOF
genotypename: tmp/v66.compatibility_HO.aadr.PUB.geno
snpname: tmp/v66.compatibility_HO.aadr.PUB.snp
indivname: tmp/v66.compatibility_HO.aadr.PUB.ind
outputformat: EIGENSTRAT
genotypeoutname: tmp/AADR_v66_HO_compatibility.geno
snpoutname: tmp/AADR_v66_HO_compatibility.snp
indivoutname: tmp/AADR_v66_HO_compatibility.ind
EOF
convertf -p tmp/convertf_parfile_AADR_v66_HO_compatibility
# convert to binary PLINK
trident genoconvert -p tmp/AADR_v66_HO_compatibility.geno --outFormat PLINK --zip -o tmp/AADR_v66_HO_compatibility
